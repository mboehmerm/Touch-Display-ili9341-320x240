...
#include <examples/lv_examples.h>             //// modified : added

/*Change to your screen resolution*/
//static const uint16_t screenWidth  = 320;   //// original, rotation 1 or 3
//static const uint16_t screenHeight = 240;   //// dito
static const uint16_t screenWidth  = 240;     //// modified, rotation 0 or 2
static const uint16_t screenHeight = 320;     //// dito
...
void setup()
{
    ...
    tft.begin();          /* TFT init */
    tft.setRotation( 0 ); /* 3 = Landscape orientation, flipped */           //// modified
    ...
    lv_example_btn_1();
   */
    // --- see folder Arduino\libraries\lvgl\src\examples\
    // lv_example_btn_1();            
    lv_example_msgbox_1();
    // lv_example_menu_1();
    // lv_example_tabview_();
